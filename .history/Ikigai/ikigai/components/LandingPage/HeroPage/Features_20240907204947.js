      ...
      <Grid container direction="row" spacing={7}>
        {features.map((feature) => (
          <Grid
            ...
            textAlign="center"
          >
            <feature.icon sx={{ fontSize: 70, color: "#import { Folder } from "@mui/icons-material";
import FolderCopyTwoToneIcon from "@mui/icons-material/FolderCopyTwoTone";
import AccountTreeTwoToneIcon from "@mui/icons-material/AccountTreeTwoTone";
import HubTwoToneIcon from "@mui/icons-material/HubTwoTone";
import { Icon, Stack, Typography, Grid, Box } from "@mui/material";
      ...
      <Grid container direction="row" spacing={5}>
        {features.map((feature) => (
          <Grid
            ...
            textAlign="center"
          >
            <feature.icon sx={{ fontSize: 70, color: "#BFAFF2" }} />
            <Typography sx={{ ...styles.bodyBold, mt: 2 }}>{feature.title}</Typography>
            <Typography sx={{ ...styles.body, mt: 1 }}>{feature.description}</Typography>
          </Grid>
        ))}
      </Grid>
    </Box>
