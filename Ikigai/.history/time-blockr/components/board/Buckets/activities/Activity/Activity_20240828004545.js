    ...
    <Card sx={{ backgroundColor: styles.backgroundColor }}>
      ...
      <CardContent>
        <Box
          ...
          sx={{
            minHeight: "50px", // Ensure the box has a minimum height
            border: "1px solid #ccc", // Add a border to visualize the box
            padding: "8px",
            marginBottom: "16px",
          }}
        >
          {isHovering ? <AddRelationships activity={activity} /> : null}
        </Box>
